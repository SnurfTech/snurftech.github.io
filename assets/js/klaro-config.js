    ...
    services: [
        {
            ...
            */
            translations: {
                ...
                en: {
                    description: 'Google Analytics is a free web analytics service that tracks and reports on website and app traffic, providing data on user behavior, demographics, and how users find someone\'s site'
                },
            },
            /*
            ...
            */
            ...
            cookies: [
              // Standard Universal Analytics (UA) and GA4 cookies
              '_ga',
              '_gid',
              '_gat',
              // Regular expression to catch all cookies starting with _ga (like _gac_...)
              /^_ga/i,
              /^_gcl_/i, // Google Click Identifier for Ads
            ],
