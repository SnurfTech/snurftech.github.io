...
<script>
  ...
  const markdownUrl = 'https://raw.githubusercontent.com/{{ site.author }}/awesome-command-blocks/refs/heads/main/command-block-combinations/orbital-strike-cannon-stab-shot.md';
